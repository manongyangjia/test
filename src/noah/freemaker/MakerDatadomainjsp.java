...
public class MakerDatadomainjsp extends TemplateObject {
	private List<DbTablename> columnsList;
	public MakerDatadomainjsp(Map<String, Object> root, List<DbTablename> columnsList) {
		this.root = root;
	...
	public static void generateFile(String filePath ,String fileName, Map<String, Object> root) throws IOException, TemplateException {
		...
		Template temp = cfg.getTemplate("dataDomainjsp.ftlh");
	...
	public void gengerateCode() {
		...
		root.put("listColumn", getDomailColumn(columnsList));
		...
		String fileName1 = pathName + packageName.replace(".", "/") + "/" + fileName + ".jsp";
		try {
