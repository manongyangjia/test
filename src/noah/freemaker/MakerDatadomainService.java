...
public class MakerDatadomainService  extends TemplateObject{
	private List<DbTablename> columnsList;
	public MakerDatadomainService(Map<String, Object> root, List<DbTablename> columnsList) {
		this.root = root;
	...
	public static void generateFile(String filePath, String fileName, Map<String, Object> root) throws IOException, TemplateException {
		...
		Template temp = cfg.getTemplate("dataDomainservice.ftlh");
	...
	public void gengerateCode() {
		...
		String fileName1 = pathName + packageName.replace(".", "/") + "/" + dataDomain + ".java";
		try {
