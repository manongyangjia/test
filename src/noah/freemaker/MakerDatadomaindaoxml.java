...
public class MakerDatadomaindaoxml extends TemplateObject {
	private List<DbTablename> columnsList;
	public MakerDatadomaindaoxml(Map<String, Object> root, List<DbTablename> columnsList) {
		this.root = root;
	...
	public static void generateFile(String filePath, String fileName, Map<String, Object> root) throws IOException, TemplateException {
		...
		Template temp = cfg.getTemplate("dataDomaindaoxml.ftlh");
	...
	public void gengerateCode() {
		...
		root.put("allColunm", getAddDomailColumn(columnsList));
		...
		String fileName = pathName + packageName.replace(".", "/") + "/" + dataDomain + ".xml";
		try {
